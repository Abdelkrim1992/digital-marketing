        ...
        <section class="contact-area pt-120 pb-120">
            <div class="container">
                <div class="section-header-two mb-90 text-center">
                    <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1000ms">{{$contact->title}}</h5>
                    <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1000ms">{{$contact->big_title}}
                        
                    </h2>
                    <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">{{$contact->main_text}}
                </div>
                <div class="row g-4">
                    <div class="col-lg-4">
