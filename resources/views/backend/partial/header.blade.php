...
<a href="index.html" class="logo"><img src="{{asset('backend/img/logo.png')}}" alt=""></a>
<a href="index.html" class="logo-small"><img src="{{asset('backend/img/logo-small.png')}}" alt=""></a>
