...
<span class="user-img"><img src="{{asset('backend/img/profiles/avatar-1.jpg')}}" alt="">
...
<a class="dropdown-item" href="{{route('setting.index')}}"><i class="me-2" data-feather="settings"></i>Settings</a>
<hr class="m-0">
