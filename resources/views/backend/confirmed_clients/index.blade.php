									...
									<div class="card card-flush">
										...
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											...
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												<!--begin::Add product-->
												<a href="{{route('confirmed-clients.create')}}" class="btn btn-primary">Add client</a>
												<!--end::Add product-->
											</div>
											<!--end::Card toolbar-->
										</div>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
												<thead>
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
													    <th ># </th>
													    <th class="text-center min-w-100px">Client </th>
														...
														<th class="text-center min-w-150px">Project Description</th>
                                                    ...
                                                    <tr>
														...
														<td>
															<div class="d-flex align-items-center">
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="{{route('confirmed-clients.edit',$row->id)}}" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{$row->client_name}}</a>
																	<!--end::Title-->
																</div>
															</div>
														</td>
														...
														<td class="text-center pe-0">
															<span class="fw-bold">{{$row->project_description}}</span>
														</td>
                                                        <td class="text-center">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="{{route('confirmed-clients.edit',$row->id)}}" class="menu-link px-3">Edit</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
