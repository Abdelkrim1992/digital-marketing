														...
														<div class="px-7 py-5" data-kt-user-table-filter="form">
															...
															<div class="mb-10">
																...
																<select class="form-select form-select-solid fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
																	...
																	<option value="Analyst">Social media manager</option>
        ...
        <tr data-user-id="{{ $row->id }}">
            <td>
                <div class="form-check form-check-sm form-check-custom form-check-solid">
                    <input type="checkbox" class="form-check-input" data-kt-user-table-select="row_checkbox" data-user-id="{{ $row->id }}">
                </div>
            </td>
                ...
                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                    <a href="{{ route('user.edit', $row->id) }}">
                        <div class="symbol-label">
                            <img src="{{ asset('backend/img/user/' . $row->image) }}" alt="Emma Smith" class="w-100" />
                        </div>
                    </a>
                </div>
