											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
												<thead>
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="text-end min-w-100px">Speciality</th>
                                                    ...
                                                    <tr>
														<td>
															<div class="d-flex align-items-center">
																<!--begin::Thumbnail-->
																<a href="{{route('team.edit',$row->id)}}" class="symbol symbol-50px">
																	<img src="{{asset('frontend/img/team/'.$row->member_image)}}" alt="member_image">
																</a>
																<!--end::Thumbnail-->
																<div class="ms-5">
																	<!--begin::Title-->
																	<a href="{{route('team.edit',$row->id)}}" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">{{$row->member_name}}</a>
																	<!--end::Title-->
																</div>
															</div>
														</td>
														<td class="text-end pe-0">
															<span class="fw-bold">{{$row->member_speciality}}</span>
														</td>
														<td class="text-end pe-0">
															<span class="fw-bold">{{$row->email}}</span>
														</td>
                                                        <td class="text-end pe-0">
															<span class="fw-bold">{{$row->phone}}</span>
														</td>
                                                        <td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<!--begin::Menu item-->
																<div class="menu-item px-3">
																	<a href="{{route('team.delete',$row->id)}}" class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row">Delete</a>
																</div>
																<!--end::Menu item-->
															</div>
															<!--end::Menu-->
