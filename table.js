...
var KTTestimonialsList = function () {
    var e, t, n, r, o = document.getElementById("kt_table_testimonial");

    const c = () => {
        o.querySelectorAll('[data-kt-testimonial-table-filter="delete_row"]').forEach((t => {
